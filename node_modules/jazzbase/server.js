...
function jazzbaseServer(port) {
    http.createServer(function (req, res) {
        ...
        if (opSet) {
            ...
            var resultGet = jazzbase(channel).get(key);
            console.log(new Date() + " " + clientIP + " GET :: ", channel, key, resultGet);
            out = JSON.stringify(resultGet);

        } else {
            console.log(new Date() + " " + clientIP + " INVALID REQUEST :: ", channel, key, data);
